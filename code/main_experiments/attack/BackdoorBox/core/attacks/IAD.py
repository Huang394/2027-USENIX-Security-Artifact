...
class IAD(Base):
    ...
    def train(self, schedule=None):
        ...
        optimizerG = torch.optim.Adam(self.modelG.parameters(), lr=self.current_schedule['lr_G'], betas=tuple(self.current_schedule['betas_G']))
        ...
        optimizerM = torch.optim.Adam(self.modelM.parameters(), lr=self.current_schedule['lr_M'], betas=tuple(self.current_schedule['betas_M']))
